...
const refresh = async user => {
    ...
    return new UserDto.UserRefreshDto(user, accessToken)
}

module.exports = { registerUser, loginUser, logoutUser, deposit, buy, reset, refresh }